...
function raceChartData(racedata) {
    ...
    am4core.ready(function() {
        ...
        var stepDuration = 3000;        // Chart playback speed
        ...
        var year = 2012;    // setting the starting year
        ...
        function nextYear() {
            ...
            if (year > 2016) {
                year = 2012;        // reset the year if the data ends
            }
        ...
        console.log(list_main[year]);
        chart.data = list_main[year];
        categoryAxis.zoom({
            start: 0,
